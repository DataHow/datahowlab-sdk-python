...
class TestVariable(unittest.TestCase):
    ...
    def test_variant_property_categorical(self):
        ...
        api_variable = create_variable(variantDetails=Variantdetails(actual_instance=CategoricalDetails()))
        variable = Variable(api_variable)
    ...
    def test_variant_property_logical(self):
        ...
        api_variable = create_variable(variantDetails=Variantdetails(actual_instance=LogicalDetails()))
        variable = Variable(api_variable)
    ...
    def test_variant_property_flow(self):
        ...
        api_variable = create_variable(variantDetails=Variantdetails(actual_instance=FlowDetails(type=FlowType.CONTI)))
        variable = Variable(api_variable)
    ...
    def test_variant_property_spectrum(self):
        ...
        api_variable = create_variable(variantDetails=Variantdetails(actual_instance=SpectrumDetails()))
        variable = Variable(api_variable)
